...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '铁路向右延伸到东京繁华的大道, 左边是通向那亲切的令人怀念的故乡',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '星星岛的竹小竹', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '迷茫的列车就像旅途上的人们。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://starsbamboo.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '浪漫鉄道', // 网站关键词 英文逗号隔开
